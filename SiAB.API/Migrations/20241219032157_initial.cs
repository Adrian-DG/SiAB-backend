...
namespace SiAB.API.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Registros_Cargo_Descago",
                schema: "Belico",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Articulos = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DebitoA = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TipoDebito = table.Column<int>(type: "int", nullable: false),
                    CreditoA = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Registros_Cargo_Descago", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Registros_Cargo_Descago_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalSchema: "accesos",
                        principalTable: "Usuarios",
                        principalColumn: "Id");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "Admin", "0000000000", "664d6e34-853c-4f27-8e97-e4e0ac48e74b", null, false, 0, false, null, "Admin", null, "ADMIN", "AQAAAAIAAYagAAAAEKTSKFEmgobgs6g/CebPQPJHgLq6tMUTbFKUBaws82WLdF9UIig/WQ4/VMJIVAocSQ==", null, false, null, null, false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registros_Cargo_Descago_UsuarioId",
                schema: "Belico",
                table: "Registros_Cargo_Descago",
                column: "UsuarioId");
